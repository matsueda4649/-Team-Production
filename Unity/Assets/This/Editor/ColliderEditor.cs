...
public class ColliderEditor : MonoBehaviour
{
	...
	public static Vector2[] GetOutlinePath(PolygonCollider2D collider)
	{
	...
	public static Vector2[] RemoveClosePolygon(Vector2[] lPath)
	{
	...
	public static Vector2[] RemovePlane(Vector2[] lPath)
	{
