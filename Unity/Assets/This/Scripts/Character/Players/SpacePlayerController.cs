...
{
    public class SpacePlayerController : BasePlayerController, IFixedUpdatable
    {
        #region 変数宣言
        ...
        /// 惑星のゲームオブジェクトの配列
        /// </summary>
        private GameObject[] m_planetArray = new GameObject[5];
        ...
        {
            base.Initialize();
            m_planetArray = GameObject.FindGameObjectsWithTag("Planet");
        }
        ...
        public void FixedUpdateMe()
        {
            ...
            var gravity = GravityController.AddGravity(this.gameObject, m_planetArray, GetRb2D.mass);

            GetRb2D.AddForce(gravity, ForceMode2D.Force);
        }
