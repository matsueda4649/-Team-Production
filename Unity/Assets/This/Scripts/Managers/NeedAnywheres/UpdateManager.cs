...
namespace ManagerSystem
{
    public class UpdateManager : MonoBehaviour
    {
        ...
        /// Updateするオブジェクトの配列
        /// </summary>
        private IUpdatable[] m_updatableArray = new IUpdatable[INITIAL_SIZE];
        ...
        private static UpdateManager m_manager = null;
        ...
        private void Awake()
        {
            if (!m_manager)
            {
                ...
                if (!m_manager)
                {
                    ...
                    m_manager = main.SafeGetComponent<UpdateManager>();
                }
            }
